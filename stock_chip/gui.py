...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .trend-sector { display: block; width: 100%; text-align: left; border: 1px solid var(--line); border-radius: 8px; background: var(--panel-2); color: var(--ink); padding: 10px 12px; margin-bottom: 8px; cursor: pointer; font-size: 13px; }
    .trend-sector:hover { border-color: var(--accent); }
    .trend-sector-head { display: flex; justify-content: space-between; align-items: baseline; font-size: 14px; margin-bottom: 4px; }
  ...
  <script>
    ...
    async function loadTrend() {
      ...
      renderTable(document.querySelector("#trend-spikes"), data.volume_spikes || [], [
        ...
        {key:"latest_volume_lot", label:"當日量(張)"},
